---
name: apple-design
description: Apply or review Apple-style web interface design with gestures, springs, drag/swipe/sheets, interruptible motion, translucent depth, typography, and reduced-motion. Use for Apple-inspired UI/UX or motion work.
---
